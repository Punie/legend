...
impl Post {
    ...
    pub async fn all(conn: &LegendDb) -> color_eyre::Result<Vec<Post>> {
    ...
    pub async fn find_by_id(id: i32, conn: &LegendDb) -> color_eyre::Result<Option<Post>> {
    ...
    pub async fn create(new_post: NewPost, conn: &LegendDb) -> color_eyre::Result<Post> {
    ...
    #[trace::instrument(name = "Post::update", level = "info", skip(conn))]
    pub async fn delete(id: i32, conn: &LegendDb) -> color_eyre::Result<bool> {
